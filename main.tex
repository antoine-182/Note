...
\confidentialite{Ce document n'est pas confidentiel et seulement une copie peut être obtenue depuis la bibliothèque de l'ENSTA Paris.}
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\pageConfidentialite}[1]{\partb{\enstaLangMentionConfidentialite}#1\vfill}
...
\clearpage
Ce document n'est pas confidentiel et seulement une copie peut être obtenue depuis la bibliothèque de l'ENSTA Paris.
