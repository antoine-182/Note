...
% Celle-ci se forme sur les grains\footnote{Deux atomes d'hydrogènes collés sur la surface d'un grain se rencontrent et forme une molécule en se détachant de la surface. Les grains servent de catalyseur pour la formation du $\mathrm{H}_2$.} mais est immédiatement photodissocié. 
...
%C'est de plus un modèle stationnaire ce qui signifie qu'il résout la chimie et la thermique du nuage à l'équilibre. Il permet d'obtenir des résultats stationnaires.
